#ifndef OP_EQUALITY_NODE_HPP
#define OP_EQUALITY_NODE_HPP
...
class OpEqualityNode : public SyntaxTreeNode {
public:
    OpEqualityNode(SyntaxTreeNode* leftExp, SyntaxTreeNode* rightExp)
    ...
    virtual std::string toString(int indent = 0) const {
      std::stringstream ss;
      ss << std::setw(indent) << " " << "OpEqualityNode\n";
      if(leftExp)
