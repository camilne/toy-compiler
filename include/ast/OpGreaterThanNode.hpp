#ifndef OP_GREATER_THAN_NODE_HPP
#define OP_GREATER_THAN_NODE_HPP
...
class OpGreaterThanNode : public SyntaxTreeNode {
public:
    OpGreaterThanNode(SyntaxTreeNode* leftExp, SyntaxTreeNode* rightExp)
    ...
    virtual std::string toString(int indent = 0) const {
      std::stringstream ss;
      ss << std::setw(indent) << " " << "OpGreaterThanNode\n";
      if(leftExp)
