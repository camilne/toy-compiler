#ifndef OP_LESS_THAN_NODE_HPP
#define OP_LESS_THAN_NODE_HPP
...
class OpLessThanNode : public SyntaxTreeNode {
public:
    OpLessThanNode(SyntaxTreeNode* leftExp, SyntaxTreeNode* rightExp)
    ...
    virtual std::string toString(int indent = 0) const {
      std::stringstream ss;
      ss << std::setw(indent) << " " << "OpLessThanNode\n";
      if(leftExp)
