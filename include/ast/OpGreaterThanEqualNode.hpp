#ifndef OP_GREATER_THAN_EQUAL_NODE_HPP
#define OP_GREATER_THAN_EQUAL_NODE_HPP
...
class OpGreaterThanEqualNode : public SyntaxTreeNode {
public:
    OpGreaterThanEqualNode(SyntaxTreeNode* leftExp, SyntaxTreeNode* rightExp)
    ...
    virtual std::string toString(int indent = 0) const {
      std::stringstream ss;
      ss << std::setw(indent) << " " << "OpGreaterThanEqualNode\n";
      if(leftExp)
