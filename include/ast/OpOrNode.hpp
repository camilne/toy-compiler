#ifndef OP_OR_NODE_HPP
#define OP_OR_NODE_HPP
...
class OpOrNode : public SyntaxTreeNode {
public:
    OpOrNode(SyntaxTreeNode* leftExp, SyntaxTreeNode* rightExp)
