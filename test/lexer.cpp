...
TEST_CASE("tokenizes symbols", "[lexer]") {
  ...
  SECTION("inequality") {
    ...
    REQUIRE(tokens.size() == 1);
    REQUIRE(tokens[0] == yytokentype::NOT_EQUALITY);
  }
  ...
  SECTION("less than") {
    ...
    REQUIRE(tokens.size() == 1);
    REQUIRE(tokens[0] == yytokentype::LESS_THAN);
  }
  ...
  SECTION("greater than") {
    ...
    REQUIRE(tokens.size() == 1);
    REQUIRE(tokens[0] == yytokentype::GREATER_THAN);
  }
  ...
  SECTION("less than equal") {
    ...
    REQUIRE(tokens.size() == 1);
    REQUIRE(tokens[0] == yytokentype::LESS_THAN_EQUAL);
  }
  ...
  SECTION("greater than equal") {
    ...
    REQUIRE(tokens.size() == 1);
    REQUIRE(tokens[0] == yytokentype::GREATER_THAN_EQUAL);
  }
}
